...
from havana_realtor_app.users.models import User
from havana_realtor_app.users.tests.factories import UserFactory
from havana_realtor_app.users.views import (
    UserRedirectView,
    UserUpdateView,
    user_detail_view,
)
